	<?php 	
		...
		{
			header("location: http://vlana001sw.esy.es/SistemasWeb/Lab6/php/login.php?message=$logMessage");
		}else
		{
			...
			if($cont == 1)//Login exitoso
			{
				...
				header("location: http://vlana001sw.esy.es/SistemasWeb/Lab6/php/GestionPreguntas.php");//local			
			}else
			{
				$loginMessage = "Correo y/o contraseña incorrectos";
				header("location: http://vlana001sw.esy.es/SistemasWeb/Lab6/php/login.php?message=$loginMessage&varLogin=1");//local
			}		
		}
