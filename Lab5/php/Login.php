	<?php 	
		...
		}else
		{
			...
			if($cont == 1)//Login exitoso
			{
				...
				header("location: http://vlana001sw.esy.es/SistemasWeb/Lab5/php/GestionPreguntas.php");//local			
			}else
			{
				$loginMessage = "Correo y/o contraseña incorrectos";
				header("location: http://vlana001sw.esy.es/SistemasWeb/Lab5/php/login.php?message=$loginMessage&varLogin=1");//local
			}		
		}
