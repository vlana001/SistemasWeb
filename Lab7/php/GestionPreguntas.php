	...
	<!-- Visualizar el numero de preguntas insertadas por el usuario actual sobre el total -->
		<script type="text/javascript">
			...
			function enviarPregunta()
			{
				...
				req.open("POST","http://vlana001sw.esy.es/SistemasWeb/Lab7/php/InsertarPregunta.php",true);
			...
			function recibirPreguntas()
			{
				...
				req.open("GET","http://vlana001sw.esy.es/SistemasWeb/Lab7/php/verPreguntasAJAX.php",true);
				req.send();
			}
			...
			function totalPreguntasJS()
			{
				...
				req.open("GET","http://vlana001sw.esy.es/SistemasWeb/Lab7/php/TotalPreguntas.php", true);
				req.send(null);
			}
			...
			{
				$.get("http://vlana001sw.esy.es/SistemasWeb/Lab7/php/TotalPreguntas.php", function(data){
