...
<body>
		...
		<form action="InsertarPregunta.php" method="POST" id="insertar">
			<table id="tabla1">
				...
				<tr>
					<td></td>
					<td id="loginsubmit">
						<input type="submit" name="submit" value="Guardar" id="preguntasubmitbtn1">
						<!-- <input type="submit" name="submit" value="Guardar y Preguntar" id="preguntasubmitbtn2"> -->
					</td>
				</tr>
			</table>
		</form>
	<?php			
		...
		{
			header("location: http://vlana001sw.esy.es/SistemasWeb/Lab4_2/php/login.php");
		}
	?>
</body>